...
page_one <- tabPanel(
    ...
    tags$body(
        ...
        tags$p("Co2 has the effect of hindering
                   Earth's present environment. Therefore, when the content of Co2
                   in the atmosphere increases, the heat transmitted by the earth
                   to outer space will decrease, and the temperature will rise.
                   This is the greenhouse effect caused by Co2. A prominent Greenhouse Gas is Carbon Dioxide. And within this group project we would like to address the severity of the CO2 emissions and raise awareness about this issue. In doing so we want to use data visuzlizations and different data analysis on underlying trends to within climate change to educate people more about this issue. We would also like to suggest solutions through Green Development in which some developing countries are currently implementing to great effect which has seem great success in sustainable economic development."),
...
page_five <- tabPanel(
    ...
    p("On the Green Development tab you can see from the 3 different plots we can see the Percentage change in CO2 emissions, Average per capita CO2 emissions and also the CO2 emissions measured per unit of GDP of each selected country of interest. A notable country of interest is Germany. They have sustained negative Carbon growth and absolute growth within recent times and this shows that it is in fact possible to have a sustainable economy with negative CO2 growth. Further researching allowed us to indentify their country's environmental policies which helped significantly in doing so. Such as the SGI 2017 which is signing the renewable energy act and commiting research to clean energy like nuclear fusion, and also regulating highly on high greenhouse gas emission processes. Perhaps policies implemented within Germnay could be model for other developing nations as well."),
